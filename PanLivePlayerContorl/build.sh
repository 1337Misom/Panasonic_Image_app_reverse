...
echo "${LIGHTGREEN}Building${NC} PanLivePlayerSDL ${BLUE}(g++ PanLivePlayerControl.c -lSDL2 -lSDL2_image -lcurl -pthread -lturbojpeg -lao -Iincludes/ -o PanLivePlayerControl)${NC}"
